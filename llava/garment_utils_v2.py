...
_CHATGARMENT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
_GARMENTCODE_DIR = os.path.join(os.path.dirname(_CHATGARMENT_DIR), 'GarmentCodeRC')
sys.path.insert(1, _GARMENTCODE_DIR)
...
def try_generate_garments(body_measurement_path, garment_output, garment_name, output_path, 
    ...
    bodies_measurements = {
        # Our model
        'neutral': os.path.join(_GARMENTCODE_DIR, 'assets/bodies/mean_all.yaml'),
        'mean_female': os.path.join(_GARMENTCODE_DIR, 'assets/bodies/mean_female.yaml'),
        'mean_male': os.path.join(_GARMENTCODE_DIR, 'assets/bodies/mean_male.yaml'),
        # SMPL
        'f_smpl': os.path.join(_GARMENTCODE_DIR, 'assets/bodies/f_smpl_average_A40.yaml'),
        'm_smpl': os.path.join(_GARMENTCODE_DIR, 'assets/bodies/m_smpl_average_A40.yaml')
    }
...
def run_simultion_warp(pattern_spec, sim_config, output_path, easy_texture_path=None):
    ...
    paths = PathCofig(
        ...
        add_timestamp=False,
        system_path=os.path.join(_GARMENTCODE_DIR, 'system.json'),
